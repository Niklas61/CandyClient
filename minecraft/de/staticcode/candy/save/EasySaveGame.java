...
public class EasySaveGame {
    ...
    public void save() {
        ...
        try {
            FileWriter fw = new FileWriter(new File(Minecraft.getMinecraft().mcDataDir + "/Candy/" + this.fileName));
    ...
    private void loadValueString() throws Exception {
        try {
            FileReader fr = new FileReader(new File(Minecraft.getMinecraft().mcDataDir + "/Candy/" + this.fileName));
    ...
    private void generateFile() throws Exception {
        (new File(Minecraft.getMinecraft().mcDataDir + "/Candy/" + this.fileName)).getParentFile().mkdirs();
        FileWriter fw = new FileWriter(new File(Minecraft.getMinecraft().mcDataDir + "/Candy/" + this.fileName));
