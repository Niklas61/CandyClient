...
public class GuiConnecting extends GuiScreen {
        ...
        ( new Thread ( "Server Connector #" + CONNECTION_ID.incrementAndGet ( ) ) {
            public void run ( ) {
                ...
                try {
                    ...
                    Candy.getIrcHandler ( ).sendServerIp ( ip + ":" + port );
    ...
    public void drawScreen ( int mouseX , int mouseY , float partialTicks ) {
        ...
        this.ticksConnecting++;

        if (Module.getByName ( "AntiLaggLobby" ).isToggled ( )) {
            if (this.ticksConnecting > 60L && !this.connected) {
                ...
                if (mc.getCurrentServerData ( ) != null)
                    mc.displayGuiScreen ( new GuiConnecting ( this.previousGuiScreen , mc , mc.getCurrentServerData ( ) ) );
            }
        }
