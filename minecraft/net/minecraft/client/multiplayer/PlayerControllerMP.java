...
public class PlayerControllerMP {
    ...
    public boolean onPlayerDestroyBlock ( BlockPos pos , EnumFacing side ) {
        ...
        if (this.currentGameType.isCreative ( ) && Minecraft.thePlayer.getHeldItem ( ) != null
    ...
    public boolean clickBlock ( BlockPos loc , EnumFacing face ) {
        ...
        if (!this.mc.theWorld.getWorldBorder ( ).contains ( loc )) {
            ...
            if (this.currentGameType.isCreative ( )) {
                ...
                if (flag && block1.getPlayerRelativeBlockHardness ( Minecraft.thePlayer , Minecraft.thePlayer.worldObj ,
                        loc ) >= 1.0F) {
                    ...
                    this.mc.theWorld.sendBlockBreakProgress ( Minecraft.thePlayer.getEntityId ( ) , this.currentBlock ,
    ...
    public boolean onPlayerDamageBlock ( BlockPos posBlock , EnumFacing directionFacing ) {
        ...
        if (this.blockHitDelay > 0) {
            ...
            if (block.getMaterial ( ) == Material.air) {
                ...
                this.curBlockDamageMP += block.getPlayerRelativeBlockHardness ( Minecraft.thePlayer ,
                        Minecraft.thePlayer.worldObj , posBlock );
    ...
    public float getBlockReachDistance ( ) {
        if (Module.getByName ( "Teleport" ).isToggled ( ))
            return 150F;
