...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay ( float partialTicks ) {
        ...
        if (GuiComponent.getByName ( "Hud Theme" ).getActiveMode ( ).equalsIgnoreCase ( "Compact" )) {
            ...
            drawRect ( 1 , 1 , 68 , 13 , Candy.RGBtoHEX ( 5 , 5 , 5 , 190 ) );
            Candy.getVerdanaFont ( ).drawCenteredString ( Candy.NAME + " " + Candy.VERSION , 33 , 0 , Candy.RGBtoHEX ( 0 , 130 , 170 , 255 ) );
        ...
        if (!Minecraft.thePlayer.isPotionActive ( Potion.confusion )) {
            float f = Minecraft.thePlayer.prevTimeInPortal
        ...
        new IngameDrawer ( mc ).drawScreen ( );
        ...
        if (Minecraft.thePlayer.getSleepTimer ( ) > 0) {
            ...
            int j1 = Minecraft.thePlayer.getSleepTimer ( );
        ...
        if (!this.mc.gameSettings.keyBindPlayerList.isKeyDown ( ) || this.mc.isIntegratedServerRunning ( )
                && Minecraft.thePlayer.sendQueue.getPlayerInfoMap ( ).size ( ) <= 1 && scoreobjective1 == null) {
    ...
    public static double currentSlot = 0.0D;
    public BlockPos lastLocation = null;

    public int infoY;
    public int infoAlpha = 255;
    ...
    protected void renderTooltip ( ScaledResolution sr , float partialTicks ) {
        if (this.mc.getRenderViewEntity ( ) instanceof EntityPlayer) {
            ...
            if (GuiComponent.getByName ( "Hotbar Info" ).isToggled ( )) {
                drawRect ( 0 , ( ScaledResolution.getScaledHeight ( ) - 24 ) - this.infoY , ScaledResolution.getScaledWidth ( ) ,
                        ( ScaledResolution.getScaledHeight ( ) - this.infoY ) + 1 , Candy.RGBtoHEX ( 10 , 10 , 10 , 200 ) );
                drawRect ( 0 , ( ScaledResolution.getScaledHeight ( ) - 24 ) - this.infoY , ScaledResolution.getScaledWidth ( ) ,
                        ( ScaledResolution.getScaledHeight ( ) - 25 ) - this.infoY , Candy.RGBtoHEX ( 0 , 130 , 170 , 200 ) );


                int maxWidth = 0;
                if (Minecraft.fontRendererObj.getStringWidth ( Math.round ( Minecraft.thePlayer.posX * 10d ) / 10d + "" ) > maxWidth) {
                    maxWidth = Minecraft.fontRendererObj.getStringWidth ( Math.round ( Minecraft.thePlayer.posX * 10d ) / 10d + "" );
                }

                if (Minecraft.fontRendererObj.getStringWidth ( Math.round ( Minecraft.thePlayer.posY * 10d ) / 10d + "" ) > maxWidth) {
                    maxWidth = Minecraft.fontRendererObj.getStringWidth ( Math.round ( Minecraft.thePlayer.posY * 10d ) / 10d + "" );
                }

                if (Minecraft.fontRendererObj.getStringWidth ( Math.round ( Minecraft.thePlayer.posZ * 10d ) / 10d + "" ) > maxWidth) {
                    maxWidth = Minecraft.fontRendererObj.getStringWidth ( Math.round ( Minecraft.thePlayer.posZ * 10d ) / 10d + "" );
                }


                Minecraft.fontRendererObj.drawStringWithShadow ( "§fX§8: §f§o" + Math.round ( Minecraft.thePlayer.posX * 10d ) / 10d , 1 ,
                        ( ScaledResolution.getScaledHeight ( ) - 23 ) - this.infoY , -1 );
                Minecraft.fontRendererObj.drawStringWithShadow ( "§fY§8: §f§o" + Math.round ( Minecraft.thePlayer.posY * 10d ) / 10d , 1 ,
                        ( ScaledResolution.getScaledHeight ( ) - 15 ) - this.infoY , -1 );
                Minecraft.fontRendererObj.drawStringWithShadow ( "§fZ§8: §f§o" + Math.round ( Minecraft.thePlayer.posZ * 10d ) / 10d , 1 ,
                        ( ScaledResolution.getScaledHeight ( ) - 7 ) - this.infoY , -1 );
                ...
                if (this.lastLocation != null) {
                    ...
                    double lastX = this.lastLocation.getX ( );
                    double lastZ = this.lastLocation.getZ ( );

                    double diffX = Math.abs ( x - lastX );
                    double diffZ = Math.abs ( z - lastZ );
                    double dist = Math.sqrt ( diffX * diffX + diffZ * diffZ );

                    int width = Minecraft.fontRendererObj.getStringWidth ( "§fX§8: §f§o" + Math.round ( Minecraft.thePlayer.posX * 10d ) / 10d ) + 10;
                    int width2 = Minecraft.fontRendererObj.getStringWidth ( "§fZ§8: §f§o" + Math.round ( Minecraft.thePlayer.posY * 10d ) / 10d ) + 10;
                    int width3 = Minecraft.fontRendererObj.getStringWidth ( "§fY§8: §f§o" + Math.round ( Minecraft.thePlayer.posZ * 10d ) / 10d ) + 10;
                    ...
                    this.drawGradientRect ( width - 5 , ( ScaledResolution.getScaledHeight ( ) - 23 ) - this.infoY , width - 3 , ScaledResolution.getScaledHeight ( ) - this.infoY , Candy.RGBtoHEX ( 128 , 128 , 128 , 255 ) , Candy.RGBtoHEX ( 128 , 128 , 128 , 0 ) );

                    Minecraft.fontRendererObj.drawStringWithShadow ( "§fBpS§8: §f§o" + Math.round ( dist * 100D ) / 100D , width ,
                            ( ScaledResolution.getScaledHeight ( ) - 20 ) - this.infoY , -1 );

                    Minecraft.fontRendererObj.drawStringWithShadow ( "§fUsername§8: §f§o" + Minecraft.thePlayer.getName ( ) , width ,
                            ( ScaledResolution.getScaledHeight ( ) - 12 ) - this.infoY , -1 );

                    this.drawGradientRect ( ScaledResolution.getScaledWidth ( ) - 10 , ( ScaledResolution.getScaledHeight ( ) - 24 ) - this.infoY , ScaledResolution.getScaledWidth ( ) , ScaledResolution.getScaledHeight ( ) - this.infoY , Candy.RGBtoHEX ( 0 , 130 , 170 , 255 ) , Candy.RGBtoHEX ( 128 , 128 , 128 , 255 ) );

                }
            } else {
                if (this.infoY == 0)
                    drawRect ( ScaledResolution.getScaledWidth ( ) / 2 - 91 , ScaledResolution.getScaledHeight ( ) - 24 , ScaledResolution.getScaledWidth ( ) / 2 + 91 ,
                            ScaledResolution.getScaledHeight ( ) , Candy.RGBtoHEX ( 10 , 10 , 10 , 200 ) );
            }

            if (mc.currentScreen == null || !( mc.currentScreen instanceof GuiChat )) {
                double targetSlot = entityplayer.inventory.currentItem;

                if (Math.abs ( currentSlot - targetSlot ) < 0.01) {
                    currentSlot = targetSlot;
                } else {
                    currentSlot += ( targetSlot - currentSlot ) / 14d;
                }

                drawRect ( ScaledResolution.getScaledWidth ( ) / 2 - 91 + currentSlot * 20 ,
                        ScaledResolution.getScaledHeight ( ) - 24 ,
                        ScaledResolution.getScaledWidth ( ) / 2 - 91 + currentSlot * 20 + 22 ,
                        ScaledResolution.getScaledHeight ( ) , Candy.RGBtoHEX ( 0 , 130 , 170 , 200 ) );
            ...
            if (Minecraft.thePlayer.getPosition ( ) != null) {
                if (Minecraft.thePlayer.onGround)
                    lastLocation = Minecraft.thePlayer.getPosition ( );
            }
        }
    ...
    public void renderExpBar ( ScaledResolution p_175176_1_ , int p_175176_2_ ) {
        ...
        if (Minecraft.thePlayer.experienceLevel > 0) {
            ...
            int l1 = ( ScaledResolution.getScaledWidth ( ) - this.getFontRenderer ( ).getStringWidth ( s ) ) / 2;
    ...
    protected boolean showCrosshair ( ) {
        if (this.mc.gameSettings.showDebugInfo && !Minecraft.thePlayer.hasReducedDebug ( )
    ...
    private void renderPumpkinOverlay ( ScaledResolution p_180476_1_ ) {
        ...
        worldrenderer.pos ( ScaledResolution.getScaledWidth ( ) , ScaledResolution.getScaledHeight ( ) , -90.0D )
    ...
    private void func_180474_b ( float p_180474_1_ , ScaledResolution p_180474_2_ ) {
        ...
        WorldRenderer worldrenderer = tessellator.getWorldRenderer ( );
        worldrenderer.begin ( 7 , DefaultVertexFormats.POSITION_TEX );
        worldrenderer.pos ( 0.0D , ScaledResolution.getScaledHeight ( ) , -90.0D ).tex ( f , f3 )
                .endVertex ( );
        worldrenderer.pos ( ScaledResolution.getScaledWidth ( ) , ScaledResolution.getScaledHeight ( ) , -90.0D )
                .tex ( f2 , f3 ).endVertex ( );
        worldrenderer.pos ( ScaledResolution.getScaledWidth ( ) , 0.0D , -90.0D ).tex ( f2 , f1 )
                .endVertex ( );
