...
public class GuiIngestServers extends GuiScreen
{
    ...
    class ServerList extends GuiSlot
    {
        ...
        {
            super(mcIn, GuiIngestServers.this.width, GuiIngestServers.this.height, 32, GuiIngestServers.this.height - 35, (int)((double) Minecraft.fontRendererObj.FONT_HEIGHT * 3.5D));
