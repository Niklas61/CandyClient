...
public class GuiNewChat extends Gui {
                    ...
                    if (chatline != null) {
                        ...
                        if (j1 < 200 || flag) {
                            ...
                            if (l1 > 3) {
                                ...
                                Minecraft.fontRendererObj.drawStringWithShadow ( s , ( float ) i2 , ( float ) ( j2 - 8 ) ,
                                        16777215 + ( l1 << 24 ) );
    ...
    public void printChatMessageWithOptionalDeletion ( IChatComponent p_146234_1_ , int p_146234_2_ ) {
        if (Module.getByName ( "NoChat" ).isToggled ( ))
            return;
    ...
    private void setChatLine ( IChatComponent p_146237_1_ , int p_146237_2_ , int p_146237_3_ , boolean p_146237_4_ ) {
        ...
        List< IChatComponent > list = GuiUtilRenderComponents.func_178908_a ( p_146237_1_ , i , Minecraft.fontRendererObj ,
                false , false );
        ...
        if (!this.getChatOpen ( )) {
            ...
            if (j >= 0 && k >= 0) {
                ...
                if (j <= MathHelper.floor_float ( ( float ) this.getChatWidth ( ) / this.getChatScale ( ) )
                        && k < Minecraft.fontRendererObj.FONT_HEIGHT * l + l) {
                    ...
                    if (i1 >= 0 && i1 < this.field_146253_i.size ( )) {
                        ...
                        for ( IChatComponent ichatcomponent : chatline.getChatComponent ( ) ) {
                            if (ichatcomponent instanceof ChatComponentText) {
                                j1 += Minecraft.fontRendererObj.getStringWidth ( GuiUtilRenderComponents.func_178909_a (
