...
public class ServerListEntryLanDetected implements GuiListExtended.IGuiListEntry
{
    ...
    {
        Minecraft.fontRendererObj.drawString(I18n.format("lanServer.title" ), x + 32 + 3, y + 1, 16777215);
        ...
        {
            Minecraft.fontRendererObj.drawString(I18n.format("selectServer.hiddenAddress" ), x + 32 + 3, y + 12 + 11, 3158064);
        }
        else
        {
