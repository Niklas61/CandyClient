...
import de.staticcode.candy.tabgui.ModuleTab;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    public Minecraft ( GameConfiguration gameConfig ) {
        ...
        Candy.setIrcConfig ( new EasySaveGame ( "Irc.esg" ) );

        if (!Candy.getIrcConfig ( ).containsValue ( "clientUUID" )) {
            Candy.getIrcConfig ( ).setString ( "clientUUID" , UUID.randomUUID ( ).toString ( ) );
    ...
    private void startGame ( ) throws LWJGLException, IOException {
        ...
        fontRendererObj = new FontRenderer ( this.gameSettings , new ResourceLocation ( "textures/font/ascii.png" ) ,
        ...
        if (this.serverName != null) {
            ...
            this.displayGuiScreen ( new GuiMainMenu.GuiPatch ( ) );
        }
    ...
    private void createDisplay ( ) throws LWJGLException {
        ...
        Display.setTitle ( Candy.NAME + " - loading..." );
    ...
    private void setWindowIcon ( ) {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                ...
                inputstream = this.getClass ( ).getResourceAsStream ( "resources/Image.png" );
                inputstream1 = this.getClass ( ).getResourceAsStream ( "resources/Image.png" );
    ...
    public void displayCrashReport ( CrashReport crashReportIn ) {
        ...
        Candy.getIrcHandler ( ).getIrcClient ( ).disconnect ( );
    }
    ...
    private void rightClickMouse ( ) {
        if (!this.playerController.func_181040_m ( )) {
            ...
            if (this.objectMouseOver == null) {
                ...
                switch ( this.objectMouseOver.typeOfHit ) {
                    case ENTITY:
                        if (this.playerController.func_178894_a ( thePlayer , this.objectMouseOver.entityHit ,
                                this.objectMouseOver )) {
                            flag = false;
                        } else if (this.playerController.interactWithEntitySendPacket ( thePlayer ,
                    ...
                    case BLOCK:
                        ...
                        if (this.theWorld.getBlockState ( blockpos ).getBlock ( ).getMaterial ( ) != Material.air) {
                            ...
                            if (this.playerController.onPlayerRightClick ( thePlayer , this.theWorld , itemstack , blockpos ,
            ...
            if (flag) {
                ...
                if (itemstack1 != null
                        && this.playerController.sendUseItem ( thePlayer , this.theWorld , itemstack1 )) {
        ...
        categorys.sort ( new Comparator< Category > ( ) {
            ...
            public int compare ( Category o1 , Category o2 ) {
                if (GuiComponent.getByName ( "Hud Theme" ).getActiveMode ( ).equalsIgnoreCase ( "Compact" ))
                    ...
                    return Minecraft.fontRendererObj.getStringWidth ( o2.name ( ) )
                            - Minecraft.fontRendererObj.getStringWidth ( o1.name ( ) );
            }
        } );
            ...
            while ( Keyboard.next ( ) ) {
                ...
                if (Keyboard.getEventKeyState ( )) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        Module.toggleOnKeyPress ( k );

                        if (k == Keyboard.KEY_UP) {
                            if (TabGui.extend == null) {
                                if (TabGui.current > 0)
                                    TabGui.current--;
                            } else {
                                if (ModuleTab.current > 0)
                                    ModuleTab.current--;
                            }
                        }
                        if (k == Keyboard.KEY_DOWN) {
                            if (TabGui.extend == null) {
                                if (TabGui.current < this.getSortedCategoryList ( ).size ( ) - 1)
                                    TabGui.current++;
                            } else {
                                List< Module > modules = new ArrayList<> ( );
                                for ( Module mods : Module.getModuleList ( ) ) {
                                    if (mods.getCategory ( ) == TabGui.extend)
                                        modules.add ( mods );
                                }
                                ...
                                if (ModuleTab.current < ( modules.size ( ) - 1 )) {
                                    ModuleTab.current++;
                                }
                            }
                        }
                        if (k == Keyboard.KEY_RETURN) {
                            if (TabGui.extend != null) {
                                ...
                                modules.get ( ModuleTab.current ).setToggled ( !modules.get ( ModuleTab.current ).isToggled ( ) );
                            }
                        }
                        if (k == Keyboard.KEY_RIGHT) {
                            TabGui.extend = this.getSortedCategoryList ( ).get ( TabGui.current );
                            List< Module > modules = new ArrayList<> ( );
                            for ( Module mods : Module.getModuleList ( ) ) {
                                if (mods.getCategory ( ) == TabGui.extend)
                                    modules.add ( mods );
    ...
    public void setDimensionAndSpawnPlayer ( int dimension ) {
        ...
        thePlayer = this.playerController.func_178892_a ( this.theWorld ,
    ...
    public static void portMove ( float yaw , float multiplyer , float up ) {
        double moveX = -Math.sin ( Math.toRadians ( yaw ) ) * multiplyer;
        double moveZ = Math.cos ( Math.toRadians ( yaw ) ) * multiplyer;
        double moveY = up;

        thePlayer.setPosition ( moveX + thePlayer.posX , moveY + thePlayer.posY , moveZ + thePlayer.posZ );
    }

    public static void move ( float yaw , float multiplyer , float up ) {
        ...
        thePlayer.motionX = moveX;
        thePlayer.motionY = moveY;
        thePlayer.motionZ = moveZ;

    }

    public static void move ( float yaw , float multiplyer ) {
        // double moveX = -Math.sin(Math.toRadians(yaw)) * 0.1644;
