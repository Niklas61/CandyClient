...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener {
    ...
    protected boolean isRenderEntityOutlines ( ) {
        ...
        return this.entityOutlineFramebuffer != null && this.entityOutlineShader != null && Minecraft.thePlayer != null
                && Minecraft.thePlayer.isSpectator ( ) && this.mc.gameSettings.keyBindSpectatorOutlines.isKeyDown ( );
    }
    ...
    public void renderEntities ( Entity renderViewEntity , ICamera camera , float partialTicks ) {
        if (this.renderEntitiesStartupCounter > 0) {
            ...
            TileEntityRendererDispatcher.instance.cacheActiveRenderInfo ( this.theWorld , this.mc.getTextureManager ( ) ,
                    Minecraft.fontRendererObj , this.mc.getRenderViewEntity ( ) , partialTicks );
            this.renderManager.cacheActiveRenderInfo ( this.theWorld , Minecraft.fontRendererObj ,
            ...
            if (this.isRenderEntityOutlines ( )) {
                ...
                this.entityOutlineShader.setRenderingFor ( "entityOutline" );
                ...
                for ( int j = 0; j < list.size ( ); ++j ) {
                    ...
                    boolean flag1 = entity3.isInRangeToRender3d ( d0 , d1 , d2 ) && ( entity3.ignoreFrustumCheck
                            ...
                            || entity3.riddenByEntity == Minecraft.thePlayer ) && entity3 instanceof EntityPlayer;
                    ...
                    while ( true ) {
                        ...
                        while ( true ) {
                            ...
                            flag2 = this.renderManager.shouldRender ( entity2 , camera , d0 , d1 , d2 )
                                    || entity2.riddenByEntity == Minecraft.thePlayer;
                ...
                for ( int j = -this.renderDistanceChunks; j <= this.renderDistanceChunks; ++j ) {
                    for ( int k = -this.renderDistanceChunks; k <= this.renderDistanceChunks; ++k ) {
                        ...
                        if (renderchunk1 != null
                            ...
                            queue.add ( new RenderGlobal.ContainerLocalRenderInformation ( renderchunk1 , null ,
                                    0 ) );
                        }
                    }
                }
    ...
    private RenderChunk func_181562_a ( BlockPos p_181562_1_ , RenderChunk p_181562_2_ , EnumFacing p_181562_3_ ) {
        ...
        return MathHelper
                .abs_int ( p_181562_1_.getX ( ) - blockpos.getX ( ) ) > this.renderDistanceChunks * 16
                ? null
                : ( blockpos.getY ( ) >= 0 && blockpos.getY ( ) < 256
                ? ( MathHelper.abs_int ( p_181562_1_.getZ ( ) - blockpos.getZ ( ) ) > this.renderDistanceChunks
            ...
            if (this.mc.gameSettings.func_181147_e ( ) == 2) {
                ...
                for ( int i1 = -256; i1 < 256; i1 += 32 ) {
                    for ( int j1 = -256; j1 < 256; j1 += 32 ) {
                        worldrenderer.pos ( i1 + 0 , f7 , j1 + 32 )
                                .tex ( ( float ) ( i1 + 0 ) * 4.8828125E-4F + f8 ,
                                        ( float ) ( j1 + 32 ) * 4.8828125E-4F + f9 )
                                .color ( f1 , f2 , f3 , 0.8F ).endVertex ( );
                        worldrenderer.pos ( i1 + 32 , f7 , j1 + 32 )
                                .tex ( ( float ) ( i1 + 32 ) * 4.8828125E-4F + f8 ,
                                        ( float ) ( j1 + 32 ) * 4.8828125E-4F + f9 )
                                .color ( f1 , f2 , f3 , 0.8F ).endVertex ( );
                        worldrenderer.pos ( i1 + 32 , f7 , j1 + 0 )
                                .tex ( ( float ) ( i1 + 32 ) * 4.8828125E-4F + f8 ,
                                        ( float ) ( j1 + 0 ) * 4.8828125E-4F + f9 )
                                .color ( f1 , f2 , f3 , 0.8F ).endVertex ( );
                        worldrenderer.pos ( i1 + 0 , f7 , j1 + 0 )
                                .tex ( ( float ) ( i1 + 0 ) * 4.8828125E-4F + f8 ,
                                        ( float ) ( j1 + 0 ) * 4.8828125E-4F + f9 )
                                .color ( f1 , f2 , f3 , 0.8F ).endVertex ( );
                    }
    ...
    public void drawSelectionBox ( EntityPlayer player , MovingObjectPosition movingObjectPositionIn , int p_72731_3_ ,
        ...
        if (p_72731_3_ == 0 && movingObjectPositionIn.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            GlStateManager.enableBlend ( );
            GlStateManager.tryBlendFuncSeparate ( 770 , 771 , 1 , 0 );
            GL11.glColor4f ( 0.0F , 0.5F , 1F , 0.5F );
            GlStateManager.disableTexture2D ( );
            GlStateManager.depthMask ( false );
            float f = 0.002F;
            ...
            if (block.getMaterial ( ) != Material.air && this.theWorld.getWorldBorder ( ).contains ( blockpos )) {
                ...
                func_181561_a ( block.getSelectedBoundingBox ( this.theWorld , blockpos )
                        .expand ( 0.01 , 0.01 , 0.01 ).offset ( -d0 , -d1 , -d2 ) );
            }
    ...
    public static void func_181561_a ( AxisAlignedBB bb ) {
        ...
        if (this.mc != null && this.mc.getRenderViewEntity ( ) != null && this.mc.effectRenderer != null) {
            ...
            if (ignoreRange) {
                ...
                return d0 * d0 + d1 * d1 + d2 * d2 > 256.0D ? null
                        : ( i > 1 ? null
                        : this.mc.effectRenderer.spawnEffectParticle ( p_174974_1_ , p_174974_3_ , p_174974_5_ ,
