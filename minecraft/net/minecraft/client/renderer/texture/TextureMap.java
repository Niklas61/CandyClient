...
public class TextureMap extends AbstractTexture implements ITickableTextureObject
{
    ...
    public void loadTextureAtlas(IResourceManager resourceManager)
    {
        ...
        for (Entry<String, TextureAtlasSprite> entry : this.mapRegisteredSprites.entrySet())
        {
                ...
                if (texturemetadatasection != null)
                {
                    ...
                    while (iterator.hasNext())
                    {
                        ...
                        if (i2 > 0 && i2 < abufferedimage.length - 1 && abufferedimage[i2] == null)
                        {
                            ...
                            {
                                logger.error("Unable to load miplevel {} from: {}", Integer.valueOf(i2), resourcelocation2, ioexception );
                            }
                        }
                    }
                }
            ...
            if (l1 < k)
            {
                logger.warn("Texture {} with size {}x{} limits mip level from {} to {}", resourcelocation1, Integer.valueOf(textureatlassprite.getIconWidth()), Integer.valueOf(textureatlassprite.getIconHeight()), Integer.valueOf(MathHelper.calculateLogBaseTwo(k)), Integer.valueOf(MathHelper.calculateLogBaseTwo(l1)) );
                k = l1;
            }
    ...
    {
        return p_147634_2_ == 0 ? new ResourceLocation(location.getResourceDomain(), String.format("%s/%s%s", this.basePath, location.getResourcePath(), ".png" )): new ResourceLocation(location.getResourceDomain(), String.format("%s/mipmaps/%s.%d%s", this.basePath, location.getResourcePath(), Integer.valueOf(p_147634_2_), ".png" ));
    }
