...
public class ItemRenderer {
	...
	private void renderPlayerArms(AbstractClientPlayer clientPlayer) {
		...
		Render<AbstractClientPlayer> render = this.renderManager
				.getEntityRenderObject( Minecraft.thePlayer );
	...
	private void func_178105_d(float p_178105_1_) {
		float f = -0.6F * MathHelper.sin(MathHelper.sqrt_float(p_178105_1_) * (float) Math.PI);
		float f1 = 0.23F * MathHelper.sin(MathHelper.sqrt_float(p_178105_1_) * (float) Math.PI * 2);
		float f2 = -0.6F * MathHelper.sin(p_178105_1_ * (float) Math.PI);
		GlStateManager.translate(f, f1, f2);
	}
	...
	public void renderItemInFirstPerson(float partialTicks) {
		...
		AbstractClientPlayer abstractclientplayer = Minecraft.thePlayer;
		...
		if (this.itemToRender != null) {
			if (this.itemToRender.getItem() == Items.filled_map) {
				...
				case BLOCK:
					GlStateManager.rotate(30F, 1F, 0f, -0.6F);
				...
				if (!Module.getByName("AnotherHitAnimation").isToggled())
