...
public class RenderManager {
        ...
        try {
            ...
            if (render != null && this.renderEngine != null) {
                ...
                if (this.debugBoundingBox && !entity.isInvisible ( ) && !p_147939_10_
                        || ( Killaura.underAttack != null && Killaura.underAttack == entity )) {
                    try {
    ...
    private void renderDebugBoundingBox ( Entity entityIn , double p_85094_2_ , double p_85094_4_ , double p_85094_6_ ,
        ...
        if (!this.renderOutlines) {
            ...
            if (Killaura.underAttack != null && Killaura.underAttack == entityIn) {
                if (entityIn instanceof EntityLivingBase) {
                    if (( ( EntityLivingBase ) entityIn ).hurtTime > 0) {

                        AxisAlignedBB axisalignedbb1 = new AxisAlignedBB ( axisalignedbb.minX - entityIn.posX + p_85094_2_ ,
                                axisalignedbb.minY - entityIn.posY + p_85094_4_ + 2d ,
                                axisalignedbb.minZ - entityIn.posZ + p_85094_6_ ,
                                axisalignedbb.maxX - entityIn.posX + p_85094_2_ ,
                                axisalignedbb.maxY - entityIn.posY + p_85094_4_ + 0.15d ,
                        ...
                        AxisAlignedBB axisalignedbb1 = new AxisAlignedBB ( axisalignedbb.minX - entityIn.posX + p_85094_2_ ,
                                ...
                                axisalignedbb.maxY - entityIn.posY + p_85094_4_ + 0.15d ,
                                axisalignedbb.maxZ - entityIn.posZ + p_85094_6_ );
                        RenderGlobal.func_181563_a ( axisalignedbb1 , 0 , 128 , 0 , 255 );
                    }
                }
            } else {
