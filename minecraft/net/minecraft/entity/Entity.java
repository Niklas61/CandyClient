...
public abstract class Entity implements ICommandSender {
    ...
    public static List< String > sendedStatus = new ArrayList<> ( );
    ...
    public boolean collectedItem;
    public boolean stepSoundChecked;
    ...
    public boolean wasHurting;
    public boolean wasSprinting;
    public boolean stopedForSprinting;
    public boolean settedForSprinting = false;
    public boolean wasSwinged;
    ...
    public void moveEntity ( double x , double y , double z ) {
        if (this.noClip) {
            ...
            if (flag || Module.getByName ( "SafeWalk" ).isToggled ( )) {
                double d6;
