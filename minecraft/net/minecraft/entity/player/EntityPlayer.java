...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    private double laggX = 0D, laggY = 0D, laggZ = 0D;
    ...
    public double getLaggX ( ) {
        return laggX;
    }

    public double getLaggY ( ) {
        return laggY;
    }

    public double getLaggZ ( ) {
        return laggZ;
    }

    public void setLaggX ( double laggX ) {
        this.laggX = laggX;
    }

    public void setLaggY ( double laggY ) {
        this.laggY = laggY;
    }

    public void setLaggZ ( double laggZ ) {
        this.laggZ = laggZ;
    }
